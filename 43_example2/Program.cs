...
if (ValidateLines(lineData1, lineData2))
{
    ...
    Console.Write($"Точка пересечения уровнений y={lineData1[COEFFICIENT]}*X_COORD+{lineData1[CONSTANT]} и y={lineData2[COEFFICIENT]}*X_COORD+{lineData2[CONSTANT]} ");
...
double[] InputLineData(int numberOfLine)
{
    ...
    lineData[CONSTANT] = Promt($"Введите констатну для {numberOfLine} прямой >");
    return lineData;
}
